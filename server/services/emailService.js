...
const sendVerificationOTP = async (email, otp) => {
  return sendEmail({
    ...
    text: `
Your AyurvedaMart verification OTP is ${otp}.
...
const sendPasswordResetOTP = async (email, otp) => {
  return sendEmail({
    ...
    text: `
Your AyurvedaMart password reset OTP is ${otp}.
      ...
      ">
        ...
        ">
          ...
          <p style="
            ...
            line-height:1.6;
          ">
            We received a request to reset your AyurvedaMart
            account password. Use the OTP below to continue.
          </p>
